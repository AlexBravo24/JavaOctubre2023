...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//Primero necesitamos crear el HasMap para pasarselo como valopr
		...
		cuentas.put(1005, new Cuenta(1005, "Elias", 30000, "Debito", 4000, 20000));
		...
		//Vamos a probar el método retirar, pero excediendo el monto de retiro del cajero
		...
		//Vamos a probar el método retirar, pero intentando dejar por debajo del minimo
				//a la cuenta
		System.out.println("Probando método retirar excediendo el saldo de la cuenta");
		System.out.println(cajero1.retirar(1005,6000));
		
		//Vamos a probar el método depositar excediendo el saldo maximo permitido de la cuenta
	
		System.out.println("Probando método retirar excediendo el saldo de la cuenta");
		System.out.println(cajero1.retirar(1002,21000));
		
		//Vamos a probar el método depositar pero que en conjunto con el saldo actual
		// rebasan el saldo maximo permitido
		System.out.println("Probando método excediendo el saldo maximo permitido en la cuenta");
		System.out.println(cajero1.retirar(1002,18000));

		//Probando el método transferir exitoso
		...
		//Probando el método transferir dejando por debajo del minimo a la cuenta origen
