...
public class MetodosString {
	...
	public static void main(String[] args) {
		...
		//cadena de texto de un valor numérico en entero
		System.out.println("Probando el métofo .length()");
		System.out.println(cadena.length());
		
		// .charAT() - Nos devuelve el caracter de acuerdo 
		//a la posición en la que se encuentre dicho caracter
		
		System.out.println("Probando el métofo .charAt()");
		System.out.println(cadena.charAt(cadena.length()-1));
		
		// .substring() - Nos devuelve una subcadena a partir
		//del indice especificado
		System.out.println("Probando el métofo .substring()");
		System.out.println(cadena.substring(4));
		System.out.println(cadena.substring(4, 20));

		
		//.toLowerCase()/.toUpperCase()-
		//Convierte la cadena a minúscula/ Convierte la cadena a mayúsculas
