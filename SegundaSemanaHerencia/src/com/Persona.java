...
//Una vez que nuestra clases es abstracta, ya no podemos instanciarla 
//Es decir, ya no podemos crear objetos de esta clase
public abstract class Persona {
	...
	//El hecho de que no retorne un tipo de dato, no sigifica 
	...
	//de un método de ejecutar diversas acciones y de poseer varias formas 
	...
	//Declarar un método abstracto define QUÉ se va a hacer, pero no CÓMO va a hacerse 
