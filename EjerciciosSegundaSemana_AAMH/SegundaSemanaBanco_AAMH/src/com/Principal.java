...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// Vamos a probar el metodo retirar existoso
		System.out.println("Probando Método retirar existoso");
		...
		// a la cuenta
		System.out.println("Probando Método retirar, pero intentando dejar por debajo del minimo a la cuenta");
		...
		// Probando el metodo de transferir exitoso
		...
		// Probando el metodo de transferir excediendo el saldo máximo
		...
		// Probando el metodo transferir dejando por debajo del minimo a la cuenta origen
