...
public class Maps {
	...
	public static void main(String[] args) {
		...
		//HasMap: esta implementación almacena las claves en una tabla
		...
		//Agregar datos a mi HashMap - .put(calve, valor)
		...
		//El metodo .values() - nosdevuelve los valores contenidos en
		// el HashMap
