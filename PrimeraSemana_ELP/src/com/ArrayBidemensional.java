...
public class ArrayBidemensional {
	...
	public static void main(String[] args) {
		...
		//Declarando una matriz o array bidimensional con valores asginados
		//desde un inicio
...
//		System.out.println(matriz2.length);
		...
		//Existe una clase de Java que permite almacenar más de un tipo de dato
		//Y sería la clase Object
		System.out.println();
