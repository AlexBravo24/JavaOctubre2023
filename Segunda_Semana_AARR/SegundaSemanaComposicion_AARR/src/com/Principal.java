...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//Concepto de composición, podemos tener o crear objetos que formen parte de uno más grande
		
		//primero debemos tener los objetos pequeños o que forman parte del mayor
