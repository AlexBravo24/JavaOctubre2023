...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// Podemos crear primero la cuenta y después guardarla en el HashMap
		...
		// cajero
		System.out.println("Probando el método retirar excediendo el monto permitido por el cajero");
		System.out.println(cajero1.retirar(1005, 10000));

		// Vamos a probar el método retirar, pero excediendo el saldo de la cuenta
		System.out.println("Probando el método retirar excediendo el saldo de la cuenta");
		System.out.println(cajero1.retirar(1002, 4000));

		// Vamos a probar el método retirar, pero intentando dejar por debajo del saldo
		// mínimo
		// a la cuenta
		System.out.println("Probando el método retirar dejando por debajo del mínimo saldo de la cuenta");
		System.out.println(cajero1.retirar(1002, 2500));

		// Vamos a probar el método depositar exitosamente
		System.out.println("Probando el método depositar exitosamente");
		System.out.println(cajero1.depositar(1005, 16000));

		// Vamos a probar el método depositar, excediendo el saldo máximo permitido en
		// la cuenta
		System.out.println("Probando el método depositar excediendo el saldo máximo permitido en la cuenta");
		...
		System.out
				.println("Probando el método depositar excediendo el saldo máximo permitido en conjunto en la cuenta");
		System.out.println(cajero1.depositar(1002, 18000));

		// Vamos a probar el método de transferir exitoso
		System.out.println("Probando el el método transferir exitosamente");
		System.out.println(cajero1.transferir(1005, 1002, 2000));
		System.out.println(cajero1.buscarCuenta(1002));

		// Vamos a probar el método de transferir excediendo el saldo máximo
		System.out.println("Probando el el método transferir excediendo el saldo máximo");
		System.out.println(cajero1.transferir(1005, 1002, 16000));
		System.out.println(cajero1.buscarCuenta(1002));

		// Vamos a probar el método de transferir dejando por debajo del mínimo a la cuenta origen
		System.out.println("Probando el el método transferir dejando por debajo del mínimo a la cuenta origen");
		System.out.println(cajero1.transferir(1002, 1004, 4000));
		System.out.println(cajero1.buscarCuenta(1004));
		
		//Ejercicio elaborar una máquina expenderora
