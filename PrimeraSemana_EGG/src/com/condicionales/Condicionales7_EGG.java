	...
	public static void main(String[] args) {
		...
		if (alumnos >= 30) {
			if (alumnos >= 30 && alumnos <= 49) {
				System.out.println("El costo de la renta del autobús es de 95 euros");
			}else if (alumnos >= 50 && alumnos <= 99) {
				System.out.println("El costo de la renta del autobús es de 70 euros");
			}else if (alumnos >= 100) {
				System.out.println("El costo de la renta del autobús es de 65 euros");
			}
		}else {
