...
public class Maps {
	...
	public static void main(String[] args) {
		...
		//El método .keySet() - nos va a devolver el valor de las llaves del 
		//HashMap
		System.out.println(usuarios.keySet());
		System.out.println(decimales.keySet());
		
		//El método .values() - nos devuelve los valores contenidos en
		//el HashMap
		...
		//for each para imprimir todas las llaves y valores
		for(Integer i: usuarios.keySet()) {
