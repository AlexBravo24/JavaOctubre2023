...
public class Listas {
	...
	public static void main(String[] args) {
		...
		//Se implementa a través de la calse ArrayList
		...
		//Ejemplo de como declarar una Lista de elemntos
		//String
		...
		//.lastIndexOf - Devuelve el índice donde encuentra al elemento
		//la ultima vez
		...
		//el elemento que ocupa esa posición va a ser desplazado a la siguiente
		...
		//Podemos declarar una lista sin parametrizar, esto puede ser sin parametro
		//List elementos = new ArrayList();
		//o con el parametro Object
